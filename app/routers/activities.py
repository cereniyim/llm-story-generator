...
def get_all_processed_activities() -> list[ProcessedActivity]:
    """
    Reads all processed activities. Processed activity is the one that has a story generated.
...
def update_activity_with_story(activity_id: int) -> ProcessedActivity:
    """
    Updates the activity with a title and a story. Story is generated by an LLM.
    """
    try:
